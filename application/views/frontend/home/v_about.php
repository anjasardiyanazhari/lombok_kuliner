            ...
            <div class="col-md-6 col-xl-6 mb-5 mb-md-0 pb-5 pb-md-0">
                <div class="img-styleBox">
                    <div class="styleBox-border">
                        <img class="styleBox-img1 img-fluid" src="<?php echo base_url() ?>assets/frontend/img/home/about-img1.png" alt="">
                    </div>
                    <img class="styleBox-img2 img-fluid" src="<?php echo base_url() ?>assets/frontend/img/home/about-img2.png" alt="">
                </div>
            </div>
