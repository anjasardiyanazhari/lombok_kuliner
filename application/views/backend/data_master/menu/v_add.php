...
//Form Open
echo form_open_multipart(base_url('backend/data_master/Menu/proses_add/'), 'class="form-horizontal"');
?>
...
<form action="" method="POST">
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="nama" id="nama" placeholder=" Nama Menu..." value="<?php echo set_value('nama'); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="number" class="form-control" name="harga" id="harga" placeholder=" Harga Menu..." value="<?php echo set_value('harga'); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <textarea class="form-control" rows="3" name="deskripsi" id="deskripsi" placeholder=" Deskripsi..."><?php echo set_value('deskripsi'); ?></textarea>
            </div>
        </div>
